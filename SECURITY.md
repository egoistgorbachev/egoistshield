...
Версия 3.5.0 не имеет Authenticode. Ed25519 подтверждает официальный release asset, но не заменяет репутацию издателя Windows и не устраняет SmartScreen/UAC.
