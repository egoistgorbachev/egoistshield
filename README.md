...
Версия 3.5.1 не имеет CA-trusted Authenticode-подписи. Windows может показать SmartScreen; это ограничение не скрывается. Доверие канала обеспечивается Ed25519-манифестом и точными хэшами. Переход с 3.4.3 на ветку 3.5.x выполняется один раз вручную.
