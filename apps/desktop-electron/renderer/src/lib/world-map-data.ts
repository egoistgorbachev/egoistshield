...
export const COUNTRY_COORDS: Record<string, CountryPoint> = {
  ...
  nl: { lat: 52.37, lng: 4.90, name: "Нидерланды" },
  ...
  it: { lat: 41.90, lng: 12.50, name: "Италия" },
  es: { lat: 40.42, lng: -3.70, name: "Испания" },
  pt: { lat: 38.72, lng: -9.14, name: "Португалия" },
  ie: { lat: 53.35, lng: -6.26, name: "Ирландия" },
  hu: { lat: 47.50, lng: 19.04, name: "Венгрия" },
  ro: { lat: 44.43, lng: 26.10, name: "Румыния" },
  bg: { lat: 42.70, lng: 23.32, name: "Болгария" },
  ...
  by: { lat: 53.90, lng: 27.57, name: "Беларусь" },
  // ── CIS / Caucasus ──
  ...
  uz: { lat: 41.30, lng: 69.28, name: "Узбекистан" },
  ...
  ph: { lat: 14.60, lng: 120.98, name: "Филиппины" },
  il: { lat: 31.77, lng: 35.23, name: "Израиль" },
  ae: { lat: 25.20, lng: 55.27, name: "ОАЭ" },
  // ── Americas ──
  us: { lat: 38.91, lng: -77.04, name: "США" },
  ca: { lat: 45.42, lng: -75.70, name: "Канада" },
  mx: { lat: 19.43, lng: -99.13, name: "Мексика" },
  br: { lat: -15.79, lng: -47.88, name: "Бразилия" },
  ar: { lat: -34.60, lng: -58.38, name: "Аргентина" },
