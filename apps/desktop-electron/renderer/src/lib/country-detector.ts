...
const KEYWORD_MAP: Record<string, string> = {
    ...
    russia: "ru", germany: "de", netherlands: "nl",
    "united kingdom": "gb", france: "fr", finland: "fi",
    sweden: "se", turkey: "tr", poland: "pl",
    ukraine: "ua", kazakhstan: "kz", spain: "es",
    singapore: "sg", australia: "au", canada: "ca",
    bulgaria: "bg", switzerland: "ch", japan: "jp",
    "united states": "us", latvia: "lv", estonia: "ee",
    lithuania: "lt", italy: "it", austria: "at",
    hungary: "hu", romania: "ro", brazil: "br",
    india: "in", "south korea": "kr", "hong kong": "hk",
    taiwan: "tw", israel: "il",
    "united arab emirates": "ae", "south africa": "za",
    mexico: "mx", argentina: "ar", czech: "cz",
    denmark: "dk", norway: "no", ireland: "ie",
    portugal: "pt", greece: "gr", georgia: "ge",
    // Страны на русском
    россия: "ru", германия: "de", нидерланды: "nl",
    великобритания: "gb", франция: "fr", финляндия: "fi",
    швеция: "se", турция: "tr", польша: "pl",
    украина: "ua", казахстан: "kz", испания: "es",
    сингапур: "sg", австралия: "au", канада: "ca",
    болгария: "bg", швейцария: "ch", япония: "jp",
    сша: "us", латвия: "lv", эстония: "ee",
    литва: "lt", италия: "it", австрия: "at",
    // Города
    moscow: "ru", frankfurt: "de", amsterdam: "nl",
    london: "gb", paris: "fr", helsinki: "fi",
    stockholm: "se", istanbul: "tr", warsaw: "pl",
    kyiv: "ua", almaty: "kz", madrid: "es",
    sydney: "au", toronto: "ca", sofia: "bg",
    zurich: "ch", tokyo: "jp", "new york": "us",
    "los angeles": "us", miami: "us", dallas: "us",
    chicago: "us", seattle: "us", riga: "lv",
    tallinn: "ee", vilnius: "lt", milan: "it",
    vienna: "at", budapest: "hu", bucharest: "ro",
    "sao paulo": "br", mumbai: "in", seoul: "kr",
    taipei: "tw", "tel aviv": "il", dubai: "ae",
    tbilisi: "ge", oslo: "no", copenhagen: "dk",
    dublin: "ie", lisbon: "pt", prague: "cz",
    // Аббревиатуры
    usa: "us", uk: "gb", uae: "ae"
};
...
export function detectCountry(name: string): string {
    return extractCountryFromEmoji(name)
        ?? extractCountryFromKeyword(name)
        ?? extractCountryFromPrefix(name)
        ?? "un";
}
